...
locals {
  k8s_cluster_endpoint       = local.k8s_use_external_ipv4 ? yandex_kubernetes_cluster.this.master[0].external_v4_endpoint : yandex_kubernetes_cluster.this.master[0].internal_v4_endpoint
